...
Each CSV row is one Observer leaf (optionally with a single inherited measurement label), one HL7 OBX-3 identifier, or both when pairing fires. The 15 columns:

`cluster`, `observer_path`, `observer_label_values`, `observer_type`, `observer_value_class`, `observer_sample`, `observer_n_files`, `viewpoint_path`, `viewpoint_short_label`, `viewpoint_long_label`, `viewpoint_type`, `viewpoint_value_class`, `viewpoint_sample`, `viewpoint_n_files`, `notes`.
...
| observer_path | observer_label_values | observer_value_class | observer_sample | viewpoint_path | viewpoint_short_label | viewpoint_value_class | viewpoint_sample | notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fetuses[].efws |  | empty |  |  |  |  |  |  |
...
| fetuses[].measurements[].calculated_ega | AC | decimal | 26.9\|23.7\|36.4\|29.7 | OBX AbdomenFetus.AbdominalCircumference | AC | decimal | 193.7\|145.5\|189.8\|281.3\|218.1\|179 (179.0) |  |
| fetuses[].measurements[].calculated_ega | BPD | decimal | 26.9\|23.8\|37.9\|28.1 | OBX SkullFetus.BiparietalDiameter | BPD | decimal | 68.8\|39.4\|63.3\|78.5\|67.4\|53.4 |  |
| fetuses[].measurements[].calculated_ega | CRL | decimal | 11.3 | OBX EmbryonicStructuresFetus.CrownRumpLength | CRL | decimal | 70.7 |  |
| fetuses[].measurements[].calculated_ega | Cerebellum | decimal | 27.4 |  |  |  |  |  |
| fetuses[].measurements[].calculated_ega | Femur | decimal | 27.1\|23.6\|35.1\|27.4 | OBX ExtremitiesFetus.FemurUndefinedLength | Femur | decimal | 41.1\|25.4\|44.1\|63.2\|48.4\|39 (39.0) |  |
| fetuses[].measurements[].calculated_ega | HC | decimal\|integer | 26.9\|22.3\|35\|28.2 | OBX SkullFetus.HeadCircumference | HC | decimal | 225.2\|164.5\|234.7\|293.6\|240.9\|224.1 |  |
...
| fetuses[].measurements[].calculated_percentile | AC | decimal | 55.6\|50.4\|73.2\|87.5 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | BPD | decimal\|integer | 51.2\|53.2\|96\|42.1 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | CRL | integer | 0 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | Cerebellum | integer | 0 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | Femur | decimal | 46.8\|33.7\|39.4\|17.6 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | HC | decimal | 42.5\|5.1\|15.9\|34.5 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | Humerus | decimal | 49.2\|64.1 |  |  |  |  |  |
| fetuses[].measurements[].calculated_percentile | Nuchal Fold | integer | 0 |  |  |  |  |  |
...
| fetuses[].measurements[].value | AC | decimal | 22.62\|19.12\|32.3\|25.5 |  |  |  |  |  |
| fetuses[].measurements[].value | BPD | decimal\|integer | 6.68\|5.81\|9.31\|7 |  |  |  |  |  |
| fetuses[].measurements[].value | CRL | decimal | 4.48 |  |  |  |  |  |
| fetuses[].measurements[].value | Cerebellum | integer | 3 |  |  |  |  |  |
| fetuses[].measurements[].value | Femur | decimal | 5.01\|4.14\|6.92\|5.1 |  |  |  |  |  |
| fetuses[].measurements[].value | HC | decimal\|integer | 25\|20.31\|31.62\|26.2 |  |  |  |  |  |
| fetuses[].measurements[].value | Humerus | decimal | 3.9\|6.2 |  |  |  |  |  |
| fetuses[].measurements[].value | Nuchal Fold | integer | 1 |  |  |  |  |  |
...
| fetuses[].fetus.gender |  | coded_text | Unspecified | OBX BabyPatientData.Gender | Fetal sex | coded_text | normal |  |
...
| exam.ob_gyn_history.gravida |  | integer | 0 | OBX PatientAnamnesticData.Gravida | Gravida | integer | 1 |  |
| exam.ob_gyn_history.liv_children |  | integer | 0 |  |  |  |  |  |
| exam.ob_gyn_history.p_term |  | integer | 0 |  |  |  |  |  |
| exam.ob_gyn_history.para |  | integer | 0 | OBX PatientAnamnesticData.Para | Para | integer | 0 |  |
...
| exam.patient.first_name |  | coded_text | Sally | OBX PatientHistory.FirstName | First name | coded_text | Test5\|Test4\|Test3\|Test2\|Test1 |  |
| exam.patient.last_name |  | coded_text | Apple\|Blue\|Charm\|Diva\|Eclair | OBX PatientHistory.Name | Last name | coded_text | Phenotype |  |
...
| cervix.cervix.funneling |  | coded_text | Unspecified | OBX Cervix.FunnellingYN | Funneling | coded_text | Funneling absent |  |
