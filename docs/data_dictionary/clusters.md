...
Companion to [README.md](README.md). One section per cluster, in the YAML-curated clinical reading order, with paired Observer + HL7 rows on the same line where pairing fired.
